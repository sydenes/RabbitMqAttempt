...
namespace RabbitmqWatermark.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ImageName,Price,Stock")] Product product, IFormFile imageFile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ImageUrl,Price,Stock")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
